...
```{r}
#save the barplot
ggsave(bar_plot_vs_catala, filename = "plots_ms/barplot_all_sessions_all_dogs_comparison_with_Catala.png", width = 10, height = 6, scale = 0.7)
```


# Comparison with Catala - presentation
```{r}
### Plot comparison with (Catala et al., 2017)
library(ggeffects)
#create a table with our data and the one from (Catala et al., 2017)
...
#at the individual level (binomial tests, BH corrected p-values) - (could also be a bias for the experimenter)
